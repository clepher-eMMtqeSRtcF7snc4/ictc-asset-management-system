...
interface MatrixHeaderSectionProps {
  summary: string[]
}
...
export default function MatrixHeaderSection() {
  return (
        ...
        <div className="space-y-2">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>GPB Matrix</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>

            <PageHeader
              title="GPB Master Data"
              description="Manage the master data and default values used when creating and maintaining the GAD Plan and Budget (GPB) Matrix."
            />
        </div>
      </div>
          ...
          return (
            <Card key={s.label}>
              <CardContent className="px-3 py-2 xl:p-4 flex items-center gap-3">
                ...
                <div>
                  <div className="md:text-lg xl:text-2xl font-bold text-accent-foreground">{i}</div>
