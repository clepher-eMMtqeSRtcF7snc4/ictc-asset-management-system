...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 relative z-20 flex h-16 shrink-0 items-center justify-between gap-2 border-b bg-sidebar px-4 backdrop-blur transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
