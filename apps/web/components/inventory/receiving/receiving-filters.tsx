...
export const initialReceivingFilters: ReceivingFilters = {
  search: "",
  status: "ALL",
  supplier: "ALL",
}
...
export function ReceivingFilters({
  ...
  onChange: (filters: ReceivingFilters) => void
  onReset: () => void
  onColumns: () => void
}) {
  const update = (key: keyof ReceivingFilters, value: string) => onChange({ ...filters, [key]: value })
