...
export const initialStockCountFilters: StockCountFilters = {
  search: "",
  status: "ALL",
  location: "ALL",
}
...
export function StockCountFilters({
  ...
  onChange: (filters: StockCountFilters) => void
  onReset: () => void
  onColumns: () => void
}) {
  const update = (key: keyof StockCountFilters, value: string) => onChange({ ...filters, [key]: value })
    ...
    <div className="space-y-3 rounded-lg border p-4">
      <div className="flex flex-col gap-3 lg:flex-row">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-9"
            placeholder="Search reference no., location..."
          />
        </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <FilterSelect
          ...
          values={["DRAFT", "IN_PROGRESS", "COMPLETED", "ADJUSTED"]}
