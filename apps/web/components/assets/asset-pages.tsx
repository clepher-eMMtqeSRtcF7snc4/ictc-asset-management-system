  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={`Asset profile · ${assetId}`}
        action={
          <div className="flex gap-2">
            <Button variant="outline">
              <SendHorizontal /> Transfer
            </Button>
            <Button>
              <ClipboardSignature /> Assign
            </Button>
          </div>
        }
      />
        ...
        <CardContent className="grid gap-5 p-5 md:grid-cols-[1fr_auto]">
          <div className="space-y-3">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {[
                ["Property number", "MSU-ICT-2026-00145"],
                ["Serial number", "DL5450-PH-87422"],
                ["Current value", "₱41,225"],
              ].map(([label, value]) => (
                <div key={label}>
                  <p className="text-xs text-muted-foreground">{label}</p>
          ...
          <div className="flex size-28 items-center justify-center rounded-md border font-mono text-xs">
            QR CODE
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <p className="flex items-center gap-2 text-muted-foreground">
              <MapPin className="size-4" /> ICT Center · Room 204
            </p>
            <p className="text-muted-foreground">
              Accountability acknowledged on Jul 05, 2026
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <p>
              ...
              <br />
              <span className="text-muted-foreground">
                Jul 05, 2026 · Receiving DR-2026-0018
              </span>
            </p>
          </CardContent>
        </Card>
