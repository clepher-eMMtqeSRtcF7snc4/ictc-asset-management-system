...
export const assetListColumns: ColumnDef<AssetListItem>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => <SortHeader title="Asset Tag" column={column} />,
    cell: ({ row }) => (
      <Link
  ...
  },
  {
    ...
    header: ({ column }) => <SortHeader title="Property No." column={column} />,
    cell: ({ row }) => (
      <span className="font-mono text-xs">{row.original.propertyNumber}</span>
    ),
  },
  {
    accessorKey: "name",
    header: ({ column }) => <SortHeader title="Asset Name" column={column} />,
    cell: ({ row }) => (
      <span
  ...
  },
  {
    ...
    header: ({ column }) => <SortHeader title="Assigned To" column={column} />,
  ...
  },
  {
    ...
    header: "Location",
    cell: ({ row }) => (
      <span className="block max-w-36 truncate" title={row.original.location}>
  ...
  },
  {
    ...
    header: ({ column }) => <SortHeader title="Condition" column={column} />,
    cell: ({ row }) => (
      <AssetConditionBadge condition={row.original.condition} />
    ),
  },
  {
    accessorKey: "acquisitionDate",
    header: ({ column }) => <SortHeader title="Acq. Date" column={column} />,
  },
  {
    id: "actions",
    header: "Actions",
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        {!disposed && <DropdownMenuItem>Assign</DropdownMenuItem>}
        {!disposed && <DropdownMenuItem>Transfer</DropdownMenuItem>}
        {!disposed && <DropdownMenuItem>Maintenance</DropdownMenuItem>}
        <DropdownMenuSeparator />
        <DropdownMenuItem>View History</DropdownMenuItem>
        {disposed && <DropdownMenuItem>View Disposal</DropdownMenuItem>}
        <DropdownMenuItem>
          <Printer /> Print
        </DropdownMenuItem>
      </DropdownMenuContent>
