import { pgEnum, timestamp, varchar, serial, integer, boolean, text } from 'drizzle-orm/pg-core';
import { pgTable } from 'drizzle-orm/pg-core';

export const assetTypeStatusEnum = pgEnum('asset_type_status', ['active', 'inactive']);
