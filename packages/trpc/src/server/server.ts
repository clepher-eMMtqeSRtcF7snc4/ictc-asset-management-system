...
const appRouter = t.router({
  ...
  roleRouter: t.router({
    ...
    getRoles: publicProcedure.input(z.object({
    ...
    getRoleById: publicProcedure.input(z.object({ id: z.string() })).output(z.object({
      id: z.string().uuid(),
      code: z.string(),
      name: z.string(),
      description: z.string().nullable(),
    ...
    deleteRole: publicProcedure.input(z.object({ id: z.string() })).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    getRolePermissions: publicProcedure.input(z.object({ id: z.string() })).output(z.array(z.object({
      id: z.string().uuid(),
      code: z.string(),
      name: z.string(),
      description: z.string().nullable(),
  ...
  permissionRouter: t.router({
    ...
    getPermissionById: publicProcedure.input(z.object({ id: z.string() })).output(z.object({
      id: z.string().uuid(),
      code: z.string(),
      name: z.string(),
      description: z.string().nullable(),
    ...
    updatePermission: publicProcedure.input(z.object({
      id: z.string().uuid(),
      code: z.string().min(1).optional(),
      name: z.string().min(1).optional(),
      description: z.string().nullable().optional(),
  ...
  userRbacRouter: t.router({
    ...
    getCurrentUser: publicProcedure.input(z.object({})).output(z.object({
      id: z.string(),
      name: z.string(),
      email: z.string().email(),
      employeeId: z.number().int().nullable(),
